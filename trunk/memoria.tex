...
\begin{itemize}
 \item Crear una herramienta que permita medir la visibilidad de las IPs y 
 AS chilenas en los ``looking glasses''.
...
o redundante. Diez a\~nos despu\'es, un estudio similar
~\cite{routing-revisited} 
